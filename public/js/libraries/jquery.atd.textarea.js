...
AtD.suggest = function(element) {
    ...
    // console.log(errorDescription['description']);
    switch (errorDescription['description']) {
        case 'Missing Word':
            errorDescription['description'] = '脱字があります';
            break;
        case 'Wrong article':
            errorDescription['description'] = '文法ミスがあります';
            break;
        case 'Spelling':
            errorDescription['description'] = 'スペルミスがあります';
            break;
        case 'Did you mean...':
            errorDescription['description'] = 'もしかして...';
            break;
    }
