...
// var AnnotationHintDataBaseProcessor = function(){ // moduleTest の際はこちらを有効化
    ...
    uppdateDataBaseAsync = function(callback){
        ...
        var bootUpWithLoadDataBase, saveDataBaseAsJson, getDateFromChunkDataFileName;
        ...
        (function createAnnotationHintDataBase(){
            ...
            extendedFs.readFilesAsync('./ChunkData', 'json', function(chunkData, isError){
                ...
                if(isErrorOccured){
                    ...
                    callback ? bootUpWithLoadDataBase(callback) : bootUpWithLoadDataBase();    
                }else{
                    ...
                    //       その際は DB の保存は行わない．
                    if(!isErrorOccured){
                        callback ? saveDataBaseAsJson(callback) : saveDataBaseAsJson();  
                    }
                }
            });
        })();
